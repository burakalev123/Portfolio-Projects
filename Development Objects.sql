...
UPDATE STUDENT SET COURSE = 'C3' WHERE ID = 9

UPDATE COURSE
SET PRICE = PRICE + 100;

-- UPSERT = UPDATE + INSERT
UPSERT COURSE VALUES ('C20', 'TEST', 1000, 5) WHERE ID = 'C20'

DELETE FROM COURSE WHERE ID = 'C20'
...
CREATE TABLE T4H.FIRST_TABLE(
	ID INT,
	NAME NVARCHAR(10)
);

--COLUMN Table creation 
CREATE COLUMN TABLE COLUMN_TABLE(
	ID INT,
	NAME NVARCHAR(10)
);

-- Insert data without Primary key, duplicate values
INSERT INTO "T4H"."COLUMN_TABLE" 
VALUES(1, 'NAME1');
...
INSERT INTO SALES VALUES (1, 'PROD1', 50)
...
-- Default 1 for QTY Field will be assigned
INSERT INTO PK_SALES(ORDER_NO, PRODUCT) VALUES(1, 'PROD2');
...
INSERT INTO PK_SALES(PRODUCT) VALUES('PROD2');

--Create Table with Reference
CREATE TABLE PK_SALES2 LIKE PK_SALES; -- Structure Copy

CREATE TABLE PK_SALES_BACKUP
	LIKE PK_SALES WITH DATA; --Table copy with data


CREATE TABLE USER_SQ AS (
	SELECT ORDER_NO, PRODUCT FROM PK_SALES
		WHERE ORDER_NO = 1
);
...
INSERT INTO "T4H"."ATM_TRANSACTIONS" (CITY, LOCATION, AMOUNT) VALUES ('New York', 'Capitol Blvd', 250)

--Table Change
ALTER TABLE [TABLE NAME] [ADD | DROP | ALTER] (COLUMN NAME ...)

ALTER TABLE USER ADD (STATE VARCHAR(10));
ALTER TABLE USER ADD (CITY VARCHAR(10) NOT NULL DEFAULT 'SFO'); -- Yeni kolon ekledigimiz icin hem NOT NULL koyup hem de default koymazsak olmaz.
ALTER TABLE USER ADD PRIMARY KEY (ID)

ALTER TABLE USER ALTER (NAME NVARCHAR(10)) 

ALTER TABLE USER ROW -- ROW Table'a cevirdi
ALTER TABLE USER COLUMN -- COLUMN Table'a cevirdi
