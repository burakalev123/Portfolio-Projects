...
if (defaults === 1) {
	...
	if (UserDefault.properties.COSTCENTER) {
		...
		for (var zy = 0; zy < CurrentDimension_TP.length; zy++) {
			if (CurrentDimension_TP[zy].id === selection5) { //Dropdown_IP_COMPCODE.addItem(CurrentDimension_TP[z].properties.COMP_CODE_ID, CurrentDimension_TP[z].properties.COMP_CODE_ID + " " + CurrentDimension_TP[z].properties.COMP_CODE);
