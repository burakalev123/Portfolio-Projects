...
if(InputValidMin= true){if(ThisAppInputValid= true){
...
{Application.showMessage(ApplicationMessageType.Error,"The input years are invalid, please try again.");}
...
if(InputValidMin= true){if(ThisAppInputValid= true){
	if(InputAmountValid= true){
		...
		//Insert the new proposal
		 IPMember = ({id: newIPID, description: InputField_IP_DESC.getValue(),hierarchies: {PARENTID: {parentId: "TOTAL_IPS"}}, properties:
					  {
					//Activity
